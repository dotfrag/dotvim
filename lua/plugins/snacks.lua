...
if vim.g.picker == "snacks" then
  ...
  vim.keymap.set("n", "<leader>sp", function() Snacks.picker.files({ cwd = vim.fn.stdpath("data") .. "/site/pack/core/opt" }) end, { desc = "Plugin Files" })
  vim.keymap.set("n", "<leader>sP", function() Snacks.picker.grep({ cwd = vim.fn.stdpath("data") .. "/site/pack/core/opt" }) end, { desc = "Grep Plugin Files" })
