...
-- Terminal
-- vim.keymap.set({"n","t"}, "<c-/>", function() Snacks.terminal() end, { desc = "Terminal" })
...
if vim.g.picker == "snacks" then
  ...
  vim.keymap.set("n", "<leader>gD", function() Snacks.picker.git_diff({ base="origin" }) end, { desc = "Git Diff (origin)" })
