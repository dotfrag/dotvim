...
return {
  ...
  keys = {
    ...
    { "<leader>fd", function() Snacks.picker.files({ dirs = { "~/repos/dotfiles", "~/repos/dotfiles-private" }, hidden = true }) end, desc = "Find Dotfiles" },
    ...
    { "<leader>gg", function() Snacks.lazygit({ win = { width = 0, height = 0 } }) end, desc = "Lazygit" },
    { "<A-g>", function() Snacks.lazygit({ win = { width = 0, height = 0 } }) end, desc = "Lazygit" },
